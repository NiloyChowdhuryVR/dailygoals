...
import { X, Upload, Code2, AlertTriangle, CheckCircle2, FileText } from 'lucide-react';
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-slate-800 pb-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Import Roadmap JSON</h2>
                <p className="text-xs text-slate-400">Paste your custom curriculum structure below</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between text-xs gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-purple-950/60 border border-purple-800/50 text-purple-300 hover:bg-purple-900/80 transition-colors font-mono"
            >
              <FileText className="w-3.5 h-3.5" />
              Load Sample JSON
            </button>

            <label className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-800 border border-slate-700 text-slate-300 hover:bg-slate-700 cursor-pointer transition-colors font-mono">
  ...
  "phases": [
    {
      ...
      "topics": [
        { "id": 1, "name": "Topic Name", "description": "Details..." }
              ...
              rows={12}
              className="w-full rounded-xl bg-dark-950 border border-slate-800 p-4 font-mono text-xs text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-none leading-relaxed placeholder:text-slate-600"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-3 border-t border-slate-800 pt-4">
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white text-sm font-semibold shadow-lg shadow-blue-500/20 transition-all flex items-center gap-2"
            >
