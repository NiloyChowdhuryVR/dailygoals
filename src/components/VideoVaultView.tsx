        ...
        <div className="space-y-1.5">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {!isGlobalView && activeSubject && (
              <span className="px-2.5 py-0.5 rounded-full bg-blue-950 text-blue-300 text-xs font-mono font-semibold border border-blue-800/60">
                Category: {activeSubject.category || activeSubject.title}
              </span>
            )}
          </div>
          ...
          <p className="text-xs sm:text-sm text-slate-400">
            {isGlobalView
              ...
              : `Showing saved videos matching ${activeSubject?.title || 'this track'}.`}
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 self-start md:self-auto shrink-0">
          {onSwitchViewMode && (
            <button
              ...
              className="px-3.5 py-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700/80 text-slate-200 text-xs font-semibold transition-all active:scale-95"
            >
              {isGlobalView
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 via-blue-600 to-teal-500 hover:from-purple-500 hover:to-teal-400 text-white font-extrabold text-xs sm:text-sm shadow-lg shadow-purple-600/20 transition-all active:scale-95 flex items-center justify-center gap-2"
          >
